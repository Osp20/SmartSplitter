...
public class EasySplitter extends JFrame implements ActionListener,ItemListener
{
  ...
  File src;
  ImageIcon icon=new ImageIcon("tick-512.png");

  public EasySplitter()
  {
    super("Smart Splitter & Merger - Powered by Advance Java");
    ...
    fc3.addChoosableFileFilter(new filter1());
     ...
     tf3.addFocusListener(new FocusAdapter()
     {
       public void focusLost(FocusEvent fe)
       {
        ...
        { 
           JOptionPane.showMessageDialog((Container)null,tf3.getText()+" : This is not a valid size","Smart Splitter & Merger",JOptionPane.OK_OPTION);
        }
      }
     });
     getConfig();
 ...
 public void actionPerformed(ActionEvent e)
 {
   ...
   else if(e.getSource()==b5)
   {
     boolean bx=true;
     if(ctr==0)
       JOptionPane.showMessageDialog((Container)null,"No source file is selected","Smart Splitter & Merger",JOptionPane.OK_OPTION);
     else if(tf1.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"No split folder is entered","Smart Splitter & Merger",JOptionPane.OK_OPTION);
     else
     {
     ...
     for(int i=0;i<ctr;i++)
     {
      ...
      if(bx)
       JOptionPane.showMessageDialog((Container)null,"Splitted Successfully!","Smart Splitter & Merger",JOptionPane.OK_OPTION,icon);
      else
       JOptionPane.showMessageDialog((Container)null,"EasySplitter encounters some errors!  Only Correct files if any are Splitted Successfully!","Smart Splitter & Merger",JOptionPane.OK_OPTION);
     }catch(Exception ef){
        JOptionPane.showMessageDialog((Container)null,"Destination folder is not entered properly","Smart Splitter & Merger",JOptionPane.OK_OPTION);
     }
   ...
   else if(e.getSource()==b10)
   {
     ...
     if(tf4.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"No split file is entered","Smart Splitter & Merger",JOptionPane.OK_OPTION);
     else if(!(new File(tf4.getText()).exists()))
        JOptionPane.showMessageDialog((Container)null,"Split file you specified not found or not correct!","Smart Splitter & Merger ",JOptionPane.OK_OPTION);     
     else if(tf5.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"Merge folder should be entered","Smart Splitter & Merger",JOptionPane.OK_OPTION);
     else
     {
       ...
       {
        JOptionPane.showMessageDialog((Container)null,"Error occured in merging: Not merged","Smart Splitter & Merger",JOptionPane.OK_OPTION);
       }
     }
   }
   ...
   else if(e.getSource()==b12)
   {
     try
     {
       ...
       if (!flc.exists())
        JOptionPane.showMessageDialog((Container)null,"Comment File not found!","Smart Splitter & Merger",JOptionPane.OK_OPTION);
       else
       {
       ...
       JOptionPane.showMessageDialog((Container)null,"Unreadable error!","Smart Splitter & Merger1.0",JOptionPane.OK_OPTION);
     }
   }
   else if(e.getSource()==b13)
   {
    try
    {
      if (tf4.getText().equals(""))
      {
        JOptionPane.showMessageDialog((Container)null,"No split file specified!","Smart Splitter & Merger",JOptionPane.OK_OPTION);
      }  
      else if(!(new File(tf4.getText()).exists()))
      {
        JOptionPane.showMessageDialog((Container)null,"Split file you specified not found or not correct!","Smart Splitter & Merger",JOptionPane.OK_OPTION);     
      ...
      else
      {
        ...
        if(!(beg.equals("jfs")))
        {
           JOptionPane.showMessageDialog((Container)null,"Not a valid split file!","Smart Splitter & Merger",JOptionPane.OK_OPTION);
        }
        else
        {
    ...
    {
      JOptionPane.showMessageDialog((Container)null,"Unexpected Error","Smart Splitter & Merger",JOptionPane.OK_OPTION);
      clearlab();
    }
   ...
   else if(e.getSource()==b18)
   {
    if(tf6.getText().equals(""))
      JOptionPane.showMessageDialog((Container)null,"Default split folder is not empty","Smart Splitter & Merger",JOptionPane.OK_OPTION);
    else if(tf7.getText().equals(""))
      JOptionPane.showMessageDialog((Container)null,"Default merge folder is not empty","Smart Splitter & Merger",JOptionPane.OK_OPTION);
    else
    {
     setConfig();
     getConfig();
     JOptionPane.showMessageDialog((Container)null,"Default values saved!","Smart Splitter & Merger",JOptionPane.OK_OPTION);
    }
   }
                                  ...
                                  boolean wipe,boolean batch)
 {
    ...
    {
      JOptionPane.showMessageDialog((Container)null,"File not found","Smart Splitter & Merger",JOptionPane.OK_OPTION);
      return 0;
    }
    try{
    if(wipe)
    {
      ...
      if((new File("A:/")).exists())
       ...
       {
         JOptionPane.showMessageDialog((Container)null,"No floppy drive found or Floppy Disk is not inserted!!","Smart Splitter & Merger",JOptionPane.OK_OPTION);              
         return 0;
       }
    }
  ...
  public int merge(String split,String dest,boolean del)
  {
    ...
    JOptionPane.showMessageDialog((Container)null,"Merged successfully!","Smart Splitter & Merger",JOptionPane.OK_OPTION,icon);
    return 1;
  }
 ...
 class filter1 extends javax.swing.filechooser.FileFilter 
 {
  ...
  class help extends javax.swing.JFrame
  {
    ...
    help()
    {
      super("Help - Smart Splitter & Merger");
      ep=new JEditorPane();
      ...
      {
        JOptionPane.showMessageDialog((Container)null,"Unable to locate the help file!!","Smart Splitter & Merger",JOptionPane.OK_OPTION);         
      }
    } 
  ...
  class about extends javax.swing.JFrame
   {
     ...
     about()
     {
       super("About Smart Splitter & Merger");
       la1=new JLabel("  Name       : Smart Splitter & Merger");
       la2=new JLabel("  Version    : 1.0 (Pro)");
       la3=new JLabel("  Developed by : Srushti,Pooja  ");
       la4=new JLabel("                 Shubham,Onkar");
       la5=new JLabel("                 I.O.T ");
       img=new JLabel(new ImageIcon("images/t1.jpg"));
       ta=new JTextArea(5,30);       
       ta.setText("  This software is licensed as free software to \n"+ 
                   "  use and distribute to others. If any doubts,\n"+
                   "  please feel free to mail to:  osp@gmail.com");
    ...
    public sizeset()
    {
     ...
     stf2.addFocusListener(new FocusAdapter()
     {
       public void focusLost(FocusEvent fe)
       {
        ...
        { JOptionPane.showMessageDialog((Container)null,stf2.getText()+" : This is not a valid size","Smart Splitter & Merger",JOptionPane.OK_OPTION);}
